    ...
    <Fragment>
      ...
      <form onSubmit={handleSubmit}>
        <Grid container spacing={2}>
          ...
          {/*RAM*/}
          <Grid item xs={12} sm={6}>
            <TextField fullWidth label="Dung lượng RAM" name="ramMemory" value={laptopData.ramMemory} onChange={handleChange} type="number" />
          </Grid>
          <Grid item xs={12} sm={6}>
          ...
          {/*Disk*/}
          <Grid item xs={12} sm={6}>
            <TextField fullWidth label="Dung lượng ổ đĩa (GB)" name="diskCapacity" value={laptopData.diskCapacity} onChange={handleChange} type="number" />
          </Grid>
          <Grid item xs={12} sm={6}>
            <TextField fullWidth label="Thông tin chi tiết đĩa cứng" name="diskDetail" value={laptopData.diskDetail} onChange={handleChange} />
          </Grid>
          ...
          <Grid item xs={12}>
            <Typography variant="h6">Thông tin số lượng sản phẩm theo màu</Typography>
          ...
          <Grid item xs={12} sm={6}>
            ...
            >
              ...
              <Typography>
                {files.length > 0 ? `${files.length} tệp tin được chọn` : "Không có tệp nào được chọn"}
              </Typography>
            </Box>
          </Grid>
          {/*Display image*/}
